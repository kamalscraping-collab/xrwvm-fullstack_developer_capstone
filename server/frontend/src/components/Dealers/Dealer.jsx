  ...
  const get_dealer = async () => {
    try {
      ...
      if (retobj.status === 200) {
        // Check if dealer is already an object, or grab the first item if it's an array
  ...
  return (
    <div style={{ margin: "20px" }}>
      ...
      <div style={{ marginTop: "10px" }}>
        {/* Use optional chaining (?.) to prevent crashes while loading */}
        <h1 style={{ color: "grey" }}>
          {dealer?.full_name}
          
          {/* Conditionally render the button directly based on sessionStorage */}
